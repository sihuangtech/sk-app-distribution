...
### 🏠 自托管版本（当前）
这是开源的自托管版本，您可以在自己的服务器上部署。适合拥有自己基础设施且希望对数据和部署有完全控制权的用户。

### ☁️ 官方云托管版本（由彩旗工作室提供）
没有自己的服务器或想要直接使用？我们提供由彩旗工作室官方运营的云托管版本！

**开始使用：** [注册购买官方服务](https://dist.skstudio.cn)

**为什么选择我们的官方云服务：**
- ✅ **彩旗工作室官方运营** - 官方团队维护管理
- ✅ **零配置要求** - 无需服务器设置，开箱即用
- ✅ **专业技术支持** - 直接获得我们团队的技术支持
- ✅ **持续更新** - 始终享受最新功能和安全更新
- ✅ **可靠基础设施** - 企业级托管环境

**联系我们：**
- **邮箱：** contact@skstudio.cn
- **QQ群：** [点击此处加入QQ群](https://qm.qq.com/q/KSyXDRdYQI)
- **Discord服务器：** [点击此处加入Discord](https://discord.gg/thWGWq7CwA)
